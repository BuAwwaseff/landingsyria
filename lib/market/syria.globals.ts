...
export const syriaGlobals = {
  ...
  home: {
    ...
    assets: {
      ...
      gameLiveCasino: "/games/live.png",
      gameSlots: "/games/slots.png",
      gameCrashEsports: "/games/crash.png",
      gameRoulette: "/games/roullete.png",
      sportLead: "/sports/football.png",
      sportBasketball: "/sports/basketball.png",
      sportTennis: "/sports/tennis.png",
      sportEventNights: "/sports/event.png",
      offerWelcome: "/gifts/welcome.png",
      offerReload: "/gifts/cashback.png",
      offerSupport: "/gifts/support.png",
  ...
  partnership: {
    ...
    assets: {
      ...
      pathAgent: "/routes/agent.png",
      pathPartner: "/routes/partner.png",
